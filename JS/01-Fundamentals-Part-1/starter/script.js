...
const balintNew = `I'm ${firstName}, a ${year - birthYear} years old ${job}!`;
console.log(balintNew);
...
if (favourite === 23) {
  //  22 === 23 -> false
  console.log("Cool! 23 is an amazing number!"); // '23' == 23
} else if (favourite === 7) {
...
// Same statement with IF/ELSE Logic
if (day === "monday") {
  console.log("Plan course structure");
  console.log("Go to coding meetup");
} else if (day === "tuesday") {
